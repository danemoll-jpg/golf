...
/** Shared global top-10 (lowest 9-hole total wins) — same shared-Firestore-document pattern
 * as Par Five's leaderboard, just sorted the other direction. Subscribes only while the
 * modal is open. */
export function LeaderboardPanel({ onClose }: LeaderboardPanelProps) {
  ...
  // Competition ranking (1-2-2-4): ties share a place instead of one arbitrarily edging
  // out the other.
  const places =
