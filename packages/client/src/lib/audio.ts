...
const PLAYERS: Record<SoundName, () => void> = {
  deal: () => {
    sweep(220, 440, 0, 0.22, 'triangle', 0.14);
    sweep(440, 660, 0.07, 0.18, 'triangle', 0.11);
  },
  reveal: () => tone(700, 0, 0.06, 'triangle', 0.12),
  draw: () => tone(500, 0, 0.05, 'square', 0.09),
  swap: () => {
    tone(420, 0, 0.05, 'square', 0.1);
    tone(640, 0.05, 0.08, 'square', 0.1);
  },
  discardDrawn: () => tone(260, 0, 0.09, 'sawtooth', 0.1),
  layoutComplete: () => {
