// Shared display info for the bot difficulty picker — used by both the local StartScreen
// and the online LobbyScreen, so the two never drift.
...
export const DIFFICULTY_DESCRIPTIONS: Record<BotDifficulty, string> = {
  ...
  normal: 'Competent, beatable — a casual club player.',
  hard: 'Card-counts and plays sharp. A real fight.',
};
